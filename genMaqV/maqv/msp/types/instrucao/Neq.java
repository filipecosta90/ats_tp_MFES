...
public final class Neq extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Neq";


  private Neq() {}
  private static int hashCode = hashFunction();
  private static Neq gomProto = (Neq) factory.build(new Neq());
  
  /**
   * Constructor that builds a term rooted by Neq
   *
   * @return a term rooted by Neq
   */

  public static Neq make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Neq and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Neq
   */
  @Override
