...
public final class IOut extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "IOut";


  private IOut() {}
  private static int hashCode = hashFunction();
  private static IOut gomProto = (IOut) factory.build(new IOut());
  
  /**
   * Constructor that builds a term rooted by IOut
   *
   * @return a term rooted by IOut
   */

  public static IOut make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a IOut and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof IOut) {
   ...
   *
   * @return true, because this is rooted by IOut
   */
  @Override
