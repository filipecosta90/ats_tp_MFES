...
public final class GoEq extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "GoEq";


  private GoEq() {}
  private static int hashCode = hashFunction();
  private static GoEq gomProto = (GoEq) factory.build(new GoEq());
  
  /**
   * Constructor that builds a term rooted by GoEq
   *
   * @return a term rooted by GoEq
   */

  public static GoEq make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a GoEq and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof GoEq) {
   ...
   *
   * @return true, because this is rooted by GoEq
   */
  @Override
