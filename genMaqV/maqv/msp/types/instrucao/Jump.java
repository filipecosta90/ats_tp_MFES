...
public final class Jump extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Jump";


  private Jump() {}
  private int hashCode;
  private static Jump gomProto = new Jump();
    private String _id;

  /**
   * Constructor that builds a term rooted by Jump
   *
   * @return a term rooted by Jump
   */

  public static Jump make(String _id) {

    // use the proto as a model
    gomProto.initHashCode( _id);
    return (Jump) factory.build(gomProto);
   ...
   *
   * @param  _id
   * @param hashCode hashCode of Jump
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Jump and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Jump
   */
  @Override
