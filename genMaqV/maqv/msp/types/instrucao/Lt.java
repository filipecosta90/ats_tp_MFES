...
public final class Lt extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Lt";


  private Lt() {}
  private static int hashCode = hashFunction();
  private static Lt gomProto = (Lt) factory.build(new Lt());
  
  /**
   * Constructor that builds a term rooted by Lt
   *
   * @return a term rooted by Lt
   */

  public static Lt make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Lt and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Lt
   */
  @Override
  public boolean isLt() {
    return true;
