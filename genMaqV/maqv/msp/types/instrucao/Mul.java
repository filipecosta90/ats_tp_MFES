...
public final class Mul extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Mul";


  private Mul() {}
  private static int hashCode = hashFunction();
  private static Mul gomProto = (Mul) factory.build(new Mul());
  
  /**
   * Constructor that builds a term rooted by Mul
   *
   * @return a term rooted by Mul
   */

  public static Mul make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Mul and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Mul
   */
  @Override
