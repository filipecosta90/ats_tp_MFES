...
package maqv.msp.types.boool;



public final class False extends maqv.msp.types.Boool implements tom.library.sl.Visitable  {
  
  private static String symbolName = "False";


  private False() {}
  private static int hashCode = hashFunction();
  private static False gomProto = (False) factory.build(new False());
  
  /**
   * Constructor that builds a term rooted by False
   *
   * @return a term rooted by False
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a False and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by False
   */
  @Override
