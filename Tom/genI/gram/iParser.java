// $ANTLR 3.2 Sep 23, 2009 12:02:23 gram/i.g 2015-12-02 11:43:40
 package gram; 
...
public class iParser extends Parser {
    ...
    public final iParser.declaracao_return declaracao() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: dec_nodo, c3, idTipo, c4, c2, c1
            // token labels: 
    ...
    public final iParser.funcao_return funcao() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: idTipo, c7, c4, c1, c5, argumentos, c3, c2, blocoCodigo, c6, ID
            // token labels: 
        ...
        try {
            ...
            switch (alt10) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: blocoCodigo, condicao, c4, c1, c5, c2, c3, else_
                    // token labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: c3, blocoCodigo, c2, c5, c1, c4, condicao
                    // token labels: 
                    // rule labels: retval, c1, c2, c5, c4, c3
                    // token list labels: 
                    // rule list labels: 
    ...
    public final iParser.for__return for_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c8, expressao, for_declaracao, c3, c2, c1, c7, blocoCodigo, c4, condicao, c6, c5
            // token labels: 
    ...
    public final iParser.while__return while_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c4, c2, blocoCodigo, c3, c6, c1, c5, condicao
            // token labels: 
    ...
    public final iParser.call_return call() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c4, c1, parametros, c3, c2, c5, ID
            // token labels: 
            // rule labels: retval, c1, c2, c5, c4, c3
            // token list labels: 
            // rule list labels: 
    ...
    public final iParser.print__return print_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c1, c4, expressao, c5, c3, c2
            // token labels: 
            // rule labels: retval, c1, c2, c5, c4, c3
            // token list labels: 
            // rule list labels: 
    ...
    public final iParser.input__return input_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: idTipo, c3, c2, c4, c1, c5
            // token labels: 
            // rule labels: retval, c1, c2, c5, c4, c3
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt17) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: condicao_ou, c1, c2, c3, expressao, c4, condicao
                    // token labels: 
                    // rule labels: retval, c1, c2, c4, c3
                    // token list labels: 
                    // rule list labels: 
            	...
            	case 1 :
            	    ...
            	    switch (alt20) {
            	        ...
            	        case 3 :
            	            ...
            	            // AST REWRITE
            	            // elements: condicao_comparacao, c1, c2, c
            	            // token labels: 
            	            // rule labels: retval, c1, c, c2
            	            // token list labels: 
            	            // rule list labels: 
            	...
            	case 1 :
            	    ...
            	    switch (alt22) {
            	        case 1 :
            	            ...
            	            // AST REWRITE
            	            // elements: e, condicao_igualdade, c2, c1
            	            // token labels: 
            	        ...
            	        case 2 :
            	            ...
            	            // AST REWRITE
            	            // elements: c2, condicao_igualdade, c2, e
            	            // token labels: 
    ...
    public final iParser.atribuicao_return atribuicao() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: condicao, c2, c3, opAtribuicao, c4, c1, ID
            // token labels: 
            // rule labels: retval, c1, c2, c4, c3
            // token list labels: 
            // rule list labels: 
