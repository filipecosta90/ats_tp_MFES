...
public final class Mod extends gram.i.types.OpNum implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Mod";


  private Mod() {}
  private static int hashCode = hashFunction();
  private static Mod gomProto = (Mod) factory.build(new Mod());
  
  /**
   * Constructor that builds a term rooted by Mod
   *
   * @return a term rooted by Mod
   */

  public static Mod make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Mod and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Mod
   */
  @Override
