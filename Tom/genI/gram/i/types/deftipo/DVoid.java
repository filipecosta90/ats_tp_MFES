...
public final class DVoid extends gram.i.types.DefTipo implements tom.library.sl.Visitable  {
  
  private static String symbolName = "DVoid";


  private DVoid() {}
  private static int hashCode = hashFunction();
  private static DVoid gomProto = (DVoid) factory.build(new DVoid());
  
  /**
   * Constructor that builds a term rooted by DVoid
   *
   * @return a term rooted by DVoid
   */

  public static DVoid make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a DVoid and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof DVoid) {
   ...
   *
   * @return true, because this is rooted by DVoid
   */
  @Override
