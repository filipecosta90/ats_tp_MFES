...
public final class DChar extends gram.i.types.DefTipo implements tom.library.sl.Visitable  {
  
  private static String symbolName = "DChar";


  private DChar() {}
  private static int hashCode = hashFunction();
  private static DChar gomProto = (DChar) factory.build(new DChar());
  
  /**
   * Constructor that builds a term rooted by DChar
   *
   * @return a term rooted by DChar
   */

  public static DChar make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a DChar and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof DChar) {
   ...
   *
   * @return true, because this is rooted by DChar
   */
  @Override
