...
public final class And extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "And";


  private And() {}
  private static int hashCode = hashFunction();
  private static And gomProto = (And) factory.build(new And());
  
  /**
   * Constructor that builds a term rooted by And
   *
   * @return a term rooted by And
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a And and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by And
   */
  @Override
