...
public final class Soma extends gram.i.types.OpAtribuicao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Soma";


  private Soma() {}
  private static int hashCode = hashFunction();
  private static Soma gomProto = (Soma) factory.build(new Soma());
  
  /**
   * Constructor that builds a term rooted by Soma
   *
   * @return a term rooted by Soma
   */

  public static Soma make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Soma and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof Soma) {
   ...
   *
   * @return true, because this is rooted by Soma
   */
  @Override
