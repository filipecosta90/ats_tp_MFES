...
public final class Igual extends gram.i.types.OpComp implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Igual";


  private Igual() {}
  private static int hashCode = hashFunction();
  private static Igual gomProto = (Igual) factory.build(new Igual());
  
  /**
   * Constructor that builds a term rooted by Igual
   *
   * @return a term rooted by Igual
   */

  public static Igual make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Igual and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Igual
   */
  @Override
