...
package gram.i.types.opnum;



public final class Vezes extends gram.i.types.OpNum implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Vezes";


  private Vezes() {}
  private static int hashCode = hashFunction();
  private static Vezes gomProto = (Vezes) factory.build(new Vezes());
  
  /**
   * Constructor that builds a term rooted by Vezes
   *
   * @return a term rooted by Vezes
   */

  public static Vezes make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Vezes and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof Vezes) {
   ...
   *
   * @return true, because this is rooted by Vezes
   */
  @Override
