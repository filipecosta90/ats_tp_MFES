...
gram.i.types.LComentarios.fromTerm(appl.getArgument(0),atConv), gram.i.types.Expressao.fromTerm(appl.getArgument(1),atConv), gram.i.types.LComentarios.fromTerm(appl.getArgument(2),atConv)
  ...
  public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] childs) {
    if (childs.length == 3  && childs[0] instanceof gram.i.types.LComentarios && childs[1] instanceof gram.i.types.Expressao && childs[2] instanceof gram.i.types.LComentarios) {
      return make((gram.i.types.LComentarios) childs[0], (gram.i.types.Expressao) childs[1], (gram.i.types.LComentarios) childs[2]);
    } else {
