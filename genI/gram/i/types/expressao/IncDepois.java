...
public final class IncDepois extends gram.i.types.Expressao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "IncDepois";


  private IncDepois() {}
  private int hashCode;
  private static IncDepois gomProto = new IncDepois();
    private gram.i.types.OpInc _OpInc;
  private String _Id;

  /**
   * Constructor that builds a term rooted by IncDepois
   *
   * @return a term rooted by IncDepois
   */

  public static IncDepois make(gram.i.types.OpInc _OpInc, String _Id) {

    // use the proto as a model
    gomProto.initHashCode( _OpInc,  _Id);
    return (IncDepois) factory.build(gomProto);
   ...
   * @param  _OpInc
   * @param _Id
   * @param hashCode hashCode of IncDepois
   */
...
buffer.append(",");
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a IncDepois and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof IncDepois) {

      IncDepois peer = (IncDepois) obj;
   ...
   *
   * @return true, because this is rooted by IncDepois
   */
  @Override
