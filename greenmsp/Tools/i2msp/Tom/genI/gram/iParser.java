// $ANTLR 3.2 Sep 23, 2009 12:02:23 gram/i.g 2015-12-01 23:46:18
 package gram; 
...
public class iParser extends Parser {
    ...
    public final iParser.declaracao_return declaracao() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: idTipo, c1, c4, dec_nodo, c3, c2
            // token labels: 
    ...
    public final iParser.funcao_return funcao() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: idTipo, ID, c5, c2, blocoCodigo, c6, argumentos, c3, c7, c4, c1
            // token labels: 
        ...
        try {
            ...
            switch (alt10) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: c5, c2, blocoCodigo, c3, c1, else_, condicao, c4
                    // token labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: c1, c4, condicao, c3, blocoCodigo, c5, c2
                    // token labels: 
                    // rule labels: retval, c1, c2, c5, c4, c3
                    // token list labels: 
                    // rule list labels: 
    ...
    public final iParser.for__return for_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c1, c7, condicao, c2, c4, c3, for_declaracao, c8, expressao, c5, blocoCodigo, c6
            // token labels: 
    ...
    public final iParser.while__return while_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: blocoCodigo, condicao, c2, c4, c3, c6, c1, c5
            // token labels: 
    ...
    public final iParser.call_return call() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c2, c1, c5, c4, parametros, ID, c3
            // token labels: 
            // rule labels: retval, c1, c2, c5, c4, c3
            // token list labels: 
            // rule list labels: 
    ...
    public final iParser.input__return input_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c5, c4, idTipo, c3, c1, c2
            // token labels: 
            // rule labels: retval, c1, c2, c5, c4, c3
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt17) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: c2, expressao, c3, c1, condicao_ou, condicao, c4
                    // token labels: 
                    // rule labels: retval, c1, c2, c4, c3
                    // token list labels: 
                    // rule list labels: 
            	...
            	case 1 :
            	    ...
            	    switch (alt20) {
            	        ...
            	        case 4 :
            	            ...
            	            // AST REWRITE
            	            // elements: c, c2, c1, condicao_comparacao
            	            // token labels: 
            	            // rule labels: retval, c1, c2, c
            	            // token list labels: 
            	            // rule list labels: 
            	...
            	case 1 :
            	    ...
            	    switch (alt22) {
            	        case 1 :
            	            ...
            	            // AST REWRITE
            	            // elements: c2, condicao_igualdade, c1, e
            	            // token labels: 
            	        ...
            	        case 2 :
            	            ...
            	            // AST REWRITE
            	            // elements: e, c2, condicao_igualdade, c2
            	            // token labels: 
    ...
    public final iParser.atribuicao_return atribuicao() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c3, c4, condicao, ID, c1, c2, opAtribuicao
            // token labels: 
            // rule labels: retval, c1, c2, c4, c3
            // token list labels: 
            // rule list labels: 
