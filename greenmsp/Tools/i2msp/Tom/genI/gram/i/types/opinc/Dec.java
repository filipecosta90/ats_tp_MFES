...
package gram.i.types.opinc;



public final class Dec extends gram.i.types.OpInc implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Dec";


  private Dec() {}
  private static int hashCode = hashFunction();
  private static Dec gomProto = (Dec) factory.build(new Dec());
  
  /**
   * Constructor that builds a term rooted by Dec
   *
   * @return a term rooted by Dec
   */

  public static Dec make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Dec and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Dec
   */
  @Override
