...
public final class Mais extends gram.i.types.OpNum implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Mais";


  private Mais() {}
  private static int hashCode = hashFunction();
  private static Mais gomProto = (Mais) factory.build(new Mais());
  
  /**
   * Constructor that builds a term rooted by Mais
   *
   * @return a term rooted by Mais
   */

  public static Mais make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Mais and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof Mais) {
   ...
   *
   * @return true, because this is rooted by Mais
   */
  @Override
