...
public final class If extends gram.i.types.Instrucao implements tom.library.sl.Visitable  {
  ...
  public static If make(gram.i.types.LComentarios _c1, gram.i.types.LComentarios _c2, gram.i.types.LComentarios _c3, gram.i.types.Expressao _Condicao, gram.i.types.LComentarios _c4, gram.i.types.LComentarios _c5, gram.i.types.Instrucao _Instrucao1, gram.i.types.Instrucao _Instrucao2) {

    // use the proto as a model
    gomProto.initHashCode( _c1,  _c2,  _c3,  _Condicao,  _c4,  _c5,  _Instrucao1,  _Instrucao2);
   ...
   */
  private void init(gram.i.types.LComentarios _c1, gram.i.types.LComentarios _c2, gram.i.types.LComentarios _c3, gram.i.types.Expressao _Condicao, gram.i.types.LComentarios _c4, gram.i.types.LComentarios _c5, gram.i.types.Instrucao _Instrucao1, gram.i.types.Instrucao _Instrucao2, int hashCode) {
    this._c1 = _c1;
    this._c2 = _c2;
    this._c3 = _c3;
   ...
   * @param _Instrucao2
   */
  private void initHashCode(gram.i.types.LComentarios _c1, gram.i.types.LComentarios _c2, gram.i.types.LComentarios _c3, gram.i.types.Expressao _Condicao, gram.i.types.LComentarios _c4, gram.i.types.LComentarios _c5, gram.i.types.Instrucao _Instrucao1, gram.i.types.Instrucao _Instrucao2) {
    this._c1 = _c1;
    this._c2 = _c2;
    this._c3 = _c3;
    this._Condicao = _Condicao;
  ...
  public shared.SharedObject duplicate() {
    If clone = new If();
    clone.init( _c1,  _c2,  _c3,  _Condicao,  _c4,  _c5,  _Instrucao1,  _Instrucao2, hashCode);
    return clone;
  }
 ...
 //shared.SharedObject
  ...
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof If) {
      ...
      If peer = (If) obj;
      return _c1==peer._c1 && _c2==peer._c2 && _c3==peer._c3 && _Condicao==peer._Condicao && _c4==peer._c4 && _c5==peer._c5 && _Instrucao1==peer._Instrucao1 && _Instrucao2==peer._Instrucao2 && true;
    }
    return false;
  }
  ...
  public gram.i.types.Instrucao setc1(gram.i.types.LComentarios set_arg) {
    return make(set_arg, _c2, _c3, _Condicao, _c4, _c5, _Instrucao1, _Instrucao2);
  }
  ...
  public gram.i.types.Instrucao setc2(gram.i.types.LComentarios set_arg) {
    return make(_c1, set_arg, _c3, _Condicao, _c4, _c5, _Instrucao1, _Instrucao2);
  }
  ...
  public gram.i.types.Instrucao setc3(gram.i.types.LComentarios set_arg) {
    return make(_c1, _c2, set_arg, _Condicao, _c4, _c5, _Instrucao1, _Instrucao2);
  }
  ...
  public gram.i.types.Instrucao setCondicao(gram.i.types.Expressao set_arg) {
    return make(_c1, _c2, _c3, set_arg, _c4, _c5, _Instrucao1, _Instrucao2);
  }
  ...
  public gram.i.types.Instrucao setc4(gram.i.types.LComentarios set_arg) {
    return make(_c1, _c2, _c3, _Condicao, set_arg, _c5, _Instrucao1, _Instrucao2);
  }
  ...
  public gram.i.types.Instrucao setc5(gram.i.types.LComentarios set_arg) {
    return make(_c1, _c2, _c3, _Condicao, _c4, set_arg, _Instrucao1, _Instrucao2);
  }
  ...
  public gram.i.types.Instrucao setInstrucao1(gram.i.types.Instrucao set_arg) {
    return make(_c1, _c2, _c3, _Condicao, _c4, _c5, set_arg, _Instrucao2);
  }
  ...
  public gram.i.types.Instrucao setInstrucao2(gram.i.types.Instrucao set_arg) {
    return make(_c1, _c2, _c3, _Condicao, _c4, _c5, _Instrucao1, set_arg);
  }
  ...
  public aterm.ATerm toATerm() {
    ...
    return atermFactory.makeAppl(
      ...
      new aterm.ATerm[] {getc1().toATerm(), getc2().toATerm(), getc3().toATerm(), getCondicao().toATerm(), getc4().toATerm(), getc5().toATerm(), getInstrucao1().toATerm(), getInstrucao2().toATerm()});
  }
  ...
  public static gram.i.types.Instrucao fromTerm(aterm.ATerm trm, tom.library.utils.ATermConverter atConv) {
    ...
    if(trm instanceof aterm.ATermAppl) {
      ...
      if(symbolName.equals(appl.getName()) && !appl.getAFun().isQuoted()) {
        return make(
gram.i.types.LComentarios.fromTerm(appl.getArgument(0),atConv), gram.i.types.LComentarios.fromTerm(appl.getArgument(1),atConv), gram.i.types.LComentarios.fromTerm(appl.getArgument(2),atConv), gram.i.types.Expressao.fromTerm(appl.getArgument(3),atConv), gram.i.types.LComentarios.fromTerm(appl.getArgument(4),atConv), gram.i.types.LComentarios.fromTerm(appl.getArgument(5),atConv), gram.i.types.Instrucao.fromTerm(appl.getArgument(6),atConv), gram.i.types.Instrucao.fromTerm(appl.getArgument(7),atConv)
        );
      }
    }
    return null;
  ...
  public tom.library.sl.Visitable getChildAt(int index) {
    switch(index) {
      ...
      case 4: return _c4;
      case 5: return _c5;
      case 6: return _Instrucao1;
      case 7: return _Instrucao2;
  ...
  public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable v) {
    switch(index) {
      case 0: return make((gram.i.types.LComentarios) v, _c2, _c3, _Condicao, _c4, _c5, _Instrucao1, _Instrucao2);
      case 1: return make(_c1, (gram.i.types.LComentarios) v, _c3, _Condicao, _c4, _c5, _Instrucao1, _Instrucao2);
      case 2: return make(_c1, _c2, (gram.i.types.LComentarios) v, _Condicao, _c4, _c5, _Instrucao1, _Instrucao2);
      case 3: return make(_c1, _c2, _c3, (gram.i.types.Expressao) v, _c4, _c5, _Instrucao1, _Instrucao2);
      case 4: return make(_c1, _c2, _c3, _Condicao, (gram.i.types.LComentarios) v, _c5, _Instrucao1, _Instrucao2);
      case 5: return make(_c1, _c2, _c3, _Condicao, _c4, (gram.i.types.LComentarios) v, _Instrucao1, _Instrucao2);
      case 6: return make(_c1, _c2, _c3, _Condicao, _c4, _c5, (gram.i.types.Instrucao) v, _Instrucao2);
      case 7: return make(_c1, _c2, _c3, _Condicao, _c4, _c5, _Instrucao1, (gram.i.types.Instrucao) v);
  ...
  public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] childs) {
    if (childs.length == 8  && childs[0] instanceof gram.i.types.LComentarios && childs[1] instanceof gram.i.types.LComentarios && childs[2] instanceof gram.i.types.LComentarios && childs[3] instanceof gram.i.types.Expressao && childs[4] instanceof gram.i.types.LComentarios && childs[5] instanceof gram.i.types.LComentarios && childs[6] instanceof gram.i.types.Instrucao && childs[7] instanceof gram.i.types.Instrucao) {
      return make((gram.i.types.LComentarios) childs[0], (gram.i.types.LComentarios) childs[1], (gram.i.types.LComentarios) childs[2], (gram.i.types.Expressao) childs[3], (gram.i.types.LComentarios) childs[4], (gram.i.types.LComentarios) childs[5], (gram.i.types.Instrucao) childs[6], (gram.i.types.Instrucao) childs[7]);
    } else {
  ...
  public tom.library.sl.Visitable[] getChildren() {
    return new tom.library.sl.Visitable[] {  _c1,  _c2,  _c3,  _Condicao,  _c4,  _c5,  _Instrucao1,  _Instrucao2 };
  }
