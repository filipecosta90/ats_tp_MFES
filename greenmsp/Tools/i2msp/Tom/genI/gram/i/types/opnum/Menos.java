...
public final class Menos extends gram.i.types.OpNum implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Menos";


  private Menos() {}
  private static int hashCode = hashFunction();
  private static Menos gomProto = (Menos) factory.build(new Menos());
  
  /**
   * Constructor that builds a term rooted by Menos
   *
   * @return a term rooted by Menos
   */

  public static Menos make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Menos and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof Menos) {
   ...
   *
   * @return true, because this is rooted by Menos
   */
  @Override
