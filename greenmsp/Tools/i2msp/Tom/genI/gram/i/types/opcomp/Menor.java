...
public final class Menor extends gram.i.types.OpComp implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Menor";


  private Menor() {}
  private static int hashCode = hashFunction();
  private static Menor gomProto = (Menor) factory.build(new Menor());
  
  /**
   * Constructor that builds a term rooted by Menor
   *
   * @return a term rooted by Menor
   */

  public static Menor make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Menor and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Menor
   */
  @Override
