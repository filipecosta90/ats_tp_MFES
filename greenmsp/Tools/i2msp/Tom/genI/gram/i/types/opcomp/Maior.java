...
public final class Maior extends gram.i.types.OpComp implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Maior";


  private Maior() {}
  private static int hashCode = hashFunction();
  private static Maior gomProto = (Maior) factory.build(new Maior());
  
  /**
   * Constructor that builds a term rooted by Maior
   *
   * @return a term rooted by Maior
   */

  public static Maior make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Maior and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof Maior) {
   ...
   *
   * @return true, because this is rooted by Maior
   */
  @Override
