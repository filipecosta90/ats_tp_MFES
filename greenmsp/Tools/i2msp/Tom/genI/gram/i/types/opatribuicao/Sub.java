...
public final class Sub extends gram.i.types.OpAtribuicao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Sub";


  private Sub() {}
  private static int hashCode = hashFunction();
  private static Sub gomProto = (Sub) factory.build(new Sub());
  
  /**
   * Constructor that builds a term rooted by Sub
   *
   * @return a term rooted by Sub
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Sub and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Sub
   */
  @Override
