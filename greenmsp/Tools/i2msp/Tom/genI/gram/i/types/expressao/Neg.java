...
public final class Neg extends gram.i.types.Expressao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Neg";


  private Neg() {}
  private int hashCode;
  private static Neg gomProto = new Neg();
    private gram.i.types.Expressao _Expressao;

  /**
   * Constructor that builds a term rooted by Neg
   *
   * @return a term rooted by Neg
   */

  public static Neg make(gram.i.types.Expressao _Expressao) {

    // use the proto as a model
    gomProto.initHashCode( _Expressao);
    return (Neg) factory.build(gomProto);
   ...
   *
   * @param  _Expressao
   * @param hashCode hashCode of Neg
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Neg and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Neg
   */
  @Override
