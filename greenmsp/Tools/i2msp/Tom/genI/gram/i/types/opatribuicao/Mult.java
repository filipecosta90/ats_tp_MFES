...
public final class Mult extends gram.i.types.OpAtribuicao implements tom.library.sl.Visitable  {
  ...
  private static Mult gomProto = (Mult) factory.build(new Mult());
