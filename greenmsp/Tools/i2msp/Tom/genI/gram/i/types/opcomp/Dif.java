...
public final class Dif extends gram.i.types.OpComp implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Dif";


  private Dif() {}
  private static int hashCode = hashFunction();
  private static Dif gomProto = (Dif) factory.build(new Dif());
  
  /**
   * Constructor that builds a term rooted by Dif
   *
   * @return a term rooted by Dif
   */

  public static Dif make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Dif and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Dif
   */
  @Override
