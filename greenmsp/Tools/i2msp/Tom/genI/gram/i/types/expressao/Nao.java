...
public final class Nao extends gram.i.types.Expressao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Nao";


  private Nao() {}
  private int hashCode;
  private static Nao gomProto = new Nao();
    private gram.i.types.Expressao _Expressao;

  /**
   * Constructor that builds a term rooted by Nao
   *
   * @return a term rooted by Nao
   */

  public static Nao make(gram.i.types.Expressao _Expressao) {

    // use the proto as a model
    gomProto.initHashCode( _Expressao);
    return (Nao) factory.build(gomProto);
   ...
   *
   * @param  _Expressao
   * @param hashCode hashCode of Nao
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Nao and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Nao
   */
  @Override
