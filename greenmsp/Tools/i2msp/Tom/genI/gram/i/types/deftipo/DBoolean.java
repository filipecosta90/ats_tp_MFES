...
package gram.i.types.deftipo;



public final class DBoolean extends gram.i.types.DefTipo implements tom.library.sl.Visitable  {
  
  private static String symbolName = "DBoolean";


  private DBoolean() {}
  private static int hashCode = hashFunction();
  private static DBoolean gomProto = (DBoolean) factory.build(new DBoolean());
  
  /**
   * Constructor that builds a term rooted by DBoolean
   *
   * @return a term rooted by DBoolean
   */

  public static DBoolean make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a DBoolean and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by DBoolean
   */
  @Override
