...
public final class Inc extends gram.i.types.OpInc implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Inc";


  private Inc() {}
  private static int hashCode = hashFunction();
  private static Inc gomProto = (Inc) factory.build(new Inc());
  
  /**
   * Constructor that builds a term rooted by Inc
   *
   * @return a term rooted by Inc
   */

  public static Inc make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Inc and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Inc
   */
  @Override
