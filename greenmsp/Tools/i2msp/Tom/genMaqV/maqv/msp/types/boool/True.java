...
public final class True extends maqv.msp.types.Boool implements tom.library.sl.Visitable  {
  
  private static String symbolName = "True";


  private True() {}
  private static int hashCode = hashFunction();
  private static True gomProto = (True) factory.build(new True());
  
  /**
   * Constructor that builds a term rooted by True
   *
   * @return a term rooted by True
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a True and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by True
   */
  @Override
