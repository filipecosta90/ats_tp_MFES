...
public final class Store extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Store";


  private Store() {}
  private static int hashCode = hashFunction();
  private static Store gomProto = (Store) factory.build(new Store());
  
  /**
   * Constructor that builds a term rooted by Store
   *
   * @return a term rooted by Store
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Store and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Store
   */
  @Override
