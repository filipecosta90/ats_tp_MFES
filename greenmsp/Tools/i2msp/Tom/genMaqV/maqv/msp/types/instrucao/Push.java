...
public final class Push extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Push";


  private Push() {}
  private int hashCode;
  private static Push gomProto = new Push();
    private maqv.msp.types.Termo _t;

  /**
   * Constructor that builds a term rooted by Push
   *
   * @return a term rooted by Push
   */

  public static Push make(maqv.msp.types.Termo _t) {

    // use the proto as a model
    gomProto.initHashCode( _t);
    return (Push) factory.build(gomProto);
   ...
   *
   * @param  _t
   * @param hashCode hashCode of Push
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Push and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Push
   */
  @Override
