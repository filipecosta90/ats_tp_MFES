...
public final class Halt extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Halt";


  private Halt() {}
  private static int hashCode = hashFunction();
  private static Halt gomProto = (Halt) factory.build(new Halt());
  
  /**
   * Constructor that builds a term rooted by Halt
   *
   * @return a term rooted by Halt
   */

  public static Halt make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Halt and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Halt
   */
  @Override
