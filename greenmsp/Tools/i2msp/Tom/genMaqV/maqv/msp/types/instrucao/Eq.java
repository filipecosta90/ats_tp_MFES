...
public final class Eq extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Eq";


  private Eq() {}
  private static int hashCode = hashFunction();
  private static Eq gomProto = (Eq) factory.build(new Eq());
  
  /**
   * Constructor that builds a term rooted by Eq
   *
   * @return a term rooted by Eq
   */

  public static Eq make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Eq and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Eq
   */
  @Override
  public boolean isEq() {
    return true;
