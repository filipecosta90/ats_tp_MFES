...
public final class Gt extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Gt";


  private Gt() {}
  private static int hashCode = hashFunction();
  private static Gt gomProto = (Gt) factory.build(new Gt());
  
  /**
   * Constructor that builds a term rooted by Gt
   *
   * @return a term rooted by Gt
   */

  public static Gt make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Gt and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Gt
   */
  @Override
  public boolean isGt() {
    return true;
