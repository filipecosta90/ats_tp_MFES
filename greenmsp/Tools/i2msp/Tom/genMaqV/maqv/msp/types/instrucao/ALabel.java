...
public final class ALabel extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "ALabel";


  private ALabel() {}
  private int hashCode;
  private static ALabel gomProto = new ALabel();
    private String _id;

  /**
   * Constructor that builds a term rooted by ALabel
   *
   * @return a term rooted by ALabel
   */

  public static ALabel make(String _id) {

    // use the proto as a model
    gomProto.initHashCode( _id);
    return (ALabel) factory.build(gomProto);
   ...
   *
   * @param  _id
   * @param hashCode hashCode of ALabel
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a ALabel and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof ALabel) {

      ALabel peer = (ALabel) obj;
   ...
   *
   * @return true, because this is rooted by ALabel
   */
  @Override
