...
public final class Add extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  ...
  private static Add gomProto = (Add) factory.build(new Add());
