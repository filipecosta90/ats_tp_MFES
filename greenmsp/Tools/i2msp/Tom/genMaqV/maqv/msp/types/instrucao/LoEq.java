...
public final class LoEq extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "LoEq";


  private LoEq() {}
  private static int hashCode = hashFunction();
  private static LoEq gomProto = (LoEq) factory.build(new LoEq());
  
  /**
   * Constructor that builds a term rooted by LoEq
   *
   * @return a term rooted by LoEq
   */

  public static LoEq make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a LoEq and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof LoEq) {
   ...
   *
   * @return true, because this is rooted by LoEq
   */
  @Override
