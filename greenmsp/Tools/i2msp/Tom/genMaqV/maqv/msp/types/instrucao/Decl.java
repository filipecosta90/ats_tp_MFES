...
convertATermToString(appl.getArgument(0), atConv), convertATermToInt(appl.getArgument(1), atConv), convertATermToInt(appl.getArgument(2), atConv)
  ...
  public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] childs) {
    if (childs.length == 3  && childs[0] instanceof tom.library.sl.VisitableBuiltin && childs[1] instanceof tom.library.sl.VisitableBuiltin && childs[2] instanceof tom.library.sl.VisitableBuiltin) {
      return make(((tom.library.sl.VisitableBuiltin<String>)childs[0]).getBuiltin(), ((tom.library.sl.VisitableBuiltin<java.lang.Integer>)childs[1]).getBuiltin(), ((tom.library.sl.VisitableBuiltin<java.lang.Integer>)childs[2]).getBuiltin());
    } else {
