...
public final class Ret extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Ret";


  private Ret() {}
  private static int hashCode = hashFunction();
  private static Ret gomProto = (Ret) factory.build(new Ret());
  
  /**
   * Constructor that builds a term rooted by Ret
   *
   * @return a term rooted by Ret
   */

  public static Ret make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Ret and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Ret
   */
  @Override
