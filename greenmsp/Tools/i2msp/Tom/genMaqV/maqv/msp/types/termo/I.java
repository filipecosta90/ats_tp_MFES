...
public final class I extends maqv.msp.types.Termo implements tom.library.sl.Visitable  {
  
  private static String symbolName = "I";


  private I() {}
  private int hashCode;
  private static I gomProto = new I();
    private int _i;

  /**
   * Constructor that builds a term rooted by I
   *
   * @return a term rooted by I
   */

  public static I make(int _i) {

    // use the proto as a model
    gomProto.initHashCode( _i);
    return (I) factory.build(gomProto);
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a I and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by I
   */
  @Override
  public boolean isI() {
    return true;
   ...
   */
  @Override
  public maqv.msp.types.Termo seti(int set_arg) {
    return make(set_arg);
  }
