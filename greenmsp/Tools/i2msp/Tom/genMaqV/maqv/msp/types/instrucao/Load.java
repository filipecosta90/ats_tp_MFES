...
public final class Load extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Load";


  private Load() {}
  private static int hashCode = hashFunction();
  private static Load gomProto = (Load) factory.build(new Load());
  
  /**
   * Constructor that builds a term rooted by Load
   *
   * @return a term rooted by Load
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Load and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Load
   */
  @Override
