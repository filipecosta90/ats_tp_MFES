...
public final class Nott extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Nott";


  private Nott() {}
  private static int hashCode = hashFunction();
  private static Nott gomProto = (Nott) factory.build(new Nott());
  
  /**
   * Constructor that builds a term rooted by Nott
   *
   * @return a term rooted by Nott
   */

  public static Nott make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Nott and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof Nott) {
   ...
   *
   * @return true, because this is rooted by Nott
   */
  @Override
