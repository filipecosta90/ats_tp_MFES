...
public final class Jumpf extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Jumpf";


  private Jumpf() {}
  private int hashCode;
  private static Jumpf gomProto = new Jumpf();
    private String _id;

  /**
   * Constructor that builds a term rooted by Jumpf
   *
   * @return a term rooted by Jumpf
   */

  public static Jumpf make(String _id) {

    // use the proto as a model
    gomProto.initHashCode( _id);
    return (Jumpf) factory.build(gomProto);
   ...
   *
   * @param  _id
   * @param hashCode hashCode of Jumpf
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Jumpf and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof Jumpf) {

      Jumpf peer = (Jumpf) obj;
   ...
   *
   * @return true, because this is rooted by Jumpf
   */
  @Override
