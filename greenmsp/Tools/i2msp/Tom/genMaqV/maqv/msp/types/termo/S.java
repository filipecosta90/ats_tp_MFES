...
public final class S extends maqv.msp.types.Termo implements tom.library.sl.Visitable  {
  
  private static String symbolName = "S";


  private S() {}
  private int hashCode;
  private static S gomProto = new S();
    private String _id;

  /**
   * Constructor that builds a term rooted by S
   *
   * @return a term rooted by S
   */

  public static S make(String _id) {

    // use the proto as a model
    gomProto.initHashCode( _id);
    return (S) factory.build(gomProto);
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a S and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by S
   */
  @Override
  public boolean isS() {
    return true;
   ...
   */
  @Override
  public maqv.msp.types.Termo setid(String set_arg) {
    return make(set_arg);
  }
