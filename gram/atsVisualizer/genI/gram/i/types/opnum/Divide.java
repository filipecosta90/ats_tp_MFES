...
public final class Divide extends gram.i.types.OpNum implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Divide";


  private Divide() {}
  private static int hashCode = hashFunction();
  private static Divide gomProto = (Divide) factory.build(new Divide());
  
  /**
   * Constructor that builds a term rooted by Divide
   *
   * @return a term rooted by Divide
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Divide and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Divide
   */
  @Override
