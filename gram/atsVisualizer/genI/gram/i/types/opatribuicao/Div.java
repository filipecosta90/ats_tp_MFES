...
public final class Div extends gram.i.types.OpAtribuicao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Div";


  private Div() {}
  private static int hashCode = hashFunction();
  private static Div gomProto = (Div) factory.build(new Div());
  
  /**
   * Constructor that builds a term rooted by Div
   *
   * @return a term rooted by Div
   */

  public static Div make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Div and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Div
   */
  @Override
