...
public final class Vazio extends gram.i.types.LComentarios implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Vazio";


  private Vazio() {}
  private static int hashCode = hashFunction();
  private static Vazio gomProto = (Vazio) factory.build(new Vazio());
  
  /**
   * Constructor that builds a term rooted by Vazio
   *
   * @return a term rooted by Vazio
   */

  public static Vazio make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Vazio and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof Vazio) {
   ...
   *
   * @return true, because this is rooted by Vazio
   */
  @Override
