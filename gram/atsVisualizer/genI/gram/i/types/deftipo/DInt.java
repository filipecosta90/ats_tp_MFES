...
public final class DInt extends gram.i.types.DefTipo implements tom.library.sl.Visitable  {
  
  private static String symbolName = "DInt";


  private DInt() {}
  private static int hashCode = hashFunction();
  private static DInt gomProto = (DInt) factory.build(new DInt());
  
  /**
   * Constructor that builds a term rooted by DInt
   *
   * @return a term rooted by DInt
   */

  public static DInt make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a DInt and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by DInt
   */
  @Override
